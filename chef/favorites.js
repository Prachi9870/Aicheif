...
const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Lettuce", amount: "20g" },
      { name: "Tomato", amount: "1 slice" },
      { name: "Onion", amount: "1 slice" },
    ...
    steps: [
      ...
      "Cook the patty on medium-high heat for 4-5 minutes each side.",
      "Add cheese slice on top of the patty during the last minute of cooking.",
      "Toast the burger bun lightly.",
      "Spread ketchup and mayonnaise on the bottom bun.",
